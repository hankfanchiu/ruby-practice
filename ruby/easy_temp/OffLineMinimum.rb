# Have the function OffLineMinimum(strArr) take the strArr parameter
# being passed which will be an array of integers ranging from 1...n
...
# take out the smallest integer currently in the whole set.
...
def OffLineMinimum(strArr)
  ...
  while strArr.include? 'E'
    strArr.each do |element|
      if element != 'E'
        # Append all elements before first 'E' to temporary array for sorting.
        tempArr << element
      else
    ...
    # Remove minimum element from temp and original arrays for next iteration.
